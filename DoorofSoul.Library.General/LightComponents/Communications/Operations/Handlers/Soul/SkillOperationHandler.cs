                ...
                try
                {
                    ...
                    if(soul.ContainsContainer(agentContainerID))
                    {
                        if (soul.SkillLibrary.ContainsSkillInfo(heptagramSystem, skillInfoID))
                        {
                            ...
                            ErrorCode errorCode;
                            string debugMessage;
                            if (LibraryInstance.KnowledgeInterface.SkillInterface.OperateSkill(soul, soul.FindContainer(agentContainerID), soul.SkillLibrary.FindSkillInfo(heptagramSystem, skillInfoID), skillParameters, out skillResponseParameters, out errorCode, out debugMessage))
                            {
