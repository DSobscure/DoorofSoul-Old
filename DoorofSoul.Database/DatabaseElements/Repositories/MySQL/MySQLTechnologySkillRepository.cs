...
namespace DoorofSoul.Database.DatabaseElements.Repositories.MySQL
{
    public class MySQLTechnologySkillRepository : TechnologySkillRepository
    {
        ...
        {
            string sqlString = @"INSERT INTO TechnologySkills 
        ...
        {
            string sqlString = @"DELETE FROM TechnologySkills 
        ...
        public override Skill Find(int skillID)
        {
            string sqlString = @"SELECT  
                ...
                from TechnologySkills WHERE SkillID = @skillID;";
            using (MySqlCommand command = new MySqlCommand(sqlString, DataBase.Instance.Connection as MySqlConnection))
            {
                command.Parameters.AddWithValue("@skillID", skillID);
                using (MySqlDataReader reader = command.ExecuteReader())
        ...
        {
            string sqlString = @"UPDATE TechnologySkills SET 
