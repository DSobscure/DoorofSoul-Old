using DoorofSoul.Library.General.LightComponents.Communications.Responses.Handlers.Answer.FetchData;
...
namespace DoorofSoul.Library.General.LightComponents.Communications.Responses.Handlers.Answer
{
    internal class FetchDataResponseResolver : AnswerResponseHandler
    {
        ...
        internal FetchDataResponseResolver(ThroneComponents.Answer answer) : base(answer)
        {
