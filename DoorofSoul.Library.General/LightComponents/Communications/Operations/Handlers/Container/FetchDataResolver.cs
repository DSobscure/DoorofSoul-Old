using DoorofSoul.Library.General.LightComponents.Communications.Operations.Handlers.Container.FetchData;
...
namespace DoorofSoul.Library.General.LightComponents.Communications.Operations.Handlers.Container
{
    public class FetchDataResolver : ContainerOperationHandler
    {
        ...
        internal FetchDataResolver(NatureComponents.Container container) : base(container, 2)
        {
