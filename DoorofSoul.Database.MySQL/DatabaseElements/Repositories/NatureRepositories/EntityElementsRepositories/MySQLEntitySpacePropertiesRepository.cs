...
namespace DoorofSoul.Database.MySQL.DatabaseElements.Repositories.NatureRepositories.EntityElementsRepositories
{
    public class MySQLEntitySpacePropertiesRepository : EntitySpacePropertiesRepository
    {
        ...
        {
            string sqlString = @"INSERT INTO EntitySpacePropertiesCollection
                (EntityID,
                ...
                @maxAngularVelocityX, @maxAngularVelocityY, @maxAngularVelocityZ,
                @mass) ;";
            using (MySqlCommand command = new MySqlCommand(sqlString, Database.ConnectionList.NatureConnection.EntityElementsConnection.Connection as MySqlConnection))
            {
                ...
                {
                    Database.Log.ErrorFormat("MySQLEntitySpacePropertiesRepository Create EntitySpaceProperties Error EntityID: {0}", entityID);
                    return null;
                }
                else
                {
        ...
        {
            string sqlString = @"DELETE FROM EntitySpacePropertiesCollection
            ...
            using (MySqlCommand command = new MySqlCommand(sqlString, Database.ConnectionList.NatureConnection.EntityElementsConnection.Connection as MySqlConnection))
            {
                ...
                if (command.ExecuteNonQuery() <= 0)
                {
                    Database.Log.ErrorFormat("MySQLEntitySpacePropertiesRepository Delete EntitySpaceProperties Error EntityID: {0}", entityID);
                }
            }
        }
        ...
        public override EntitySpaceProperties Find(int entityID)
        {
            string sqlString = @"SELECT  
                ...
                MaxAngularVelocityX, MaxAngularVelocityY, MaxAngularVelocityZ,
                Mass
                from EntitySpacePropertiesCollection WHERE EntityID = @entityID;";
            using (MySqlCommand command = new MySqlCommand(sqlString, Database.ConnectionList.NatureConnection.EntityElementsConnection.Connection as MySqlConnection))
            {
                command.Parameters.AddWithValue("@entityID", entityID);
        ...
        {
            string sqlString = @"UPDATE EntitySpacePropertiesCollection SET 
            ...
            using (MySqlCommand command = new MySqlCommand(sqlString, Database.ConnectionList.NatureConnection.EntityElementsConnection.Connection as MySqlConnection))
            {
                ...
                if (command.ExecuteNonQuery() <= 0)
                {
                    Database.Log.ErrorFormat("MySQLEntitySpacePropertiesRepository Save EntitySpaceProperties Error EntityID: {0}", entityID);
                }
            }
        }
    }
